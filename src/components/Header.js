                    ...
                    <div className="navbar__scroller">
                      <div className="navbar__inner">
                        ...
                        <ul className="navbar__list menu">
                          ...
                          <li key={action_idx} className={classNames('navbar__item', {'navbar__item--btn': _.get(action, 'style', null) !== 'link', 'is-active': _.get(this.props, 'pageContext.url', null) === _.get(action, 'url', null)})}>
